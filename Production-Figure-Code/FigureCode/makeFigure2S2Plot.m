function makeFigure2S2Plot(dataPath, savePath)
%% Plot individual panels for figure 2---figure supplement 2
% 
warning('off', 'MATLAB:print:FigureTooLargeForPage');
global GEN_SAVE_PATH
GEN_DATA_PATH = @(fname) fullfile(dataPath, 'dual_target_sim', fname);
...
mMakePanel(...
    GEN_DATA_PATH('EIH-DualTargetSim.mat'), ...
    'EIH', 1, ...
    'fig2_s2_a1.pdf');
mMakePanel(...
    GEN_DATA_PATH('EIH-DualTargetSim.mat'), ...
    ...
    'fig2_s2_a2.pdf');
mMakePanel(...
    GEN_DATA_PATH('IF-DualTargetSim.mat'), ...
    'Infotaxis', 1, ...
    'fig2_s2_b1.pdf');
mMakePanel(...
    GEN_DATA_PATH('IF-DualTargetSim.mat'), ...
