function makeFigS2Plot(dataPath, savePath)
...
if SPLIT_PLOT
    splitprint(gcf,... %separate the current figure
        GEN_SAVE_PATH('figS2-Rat'),... %filenames will begin with 'disp2'
    ...
    print(GEN_SAVE_PATH('figS2-Rat.pdf'),'-dpdf');
end
