...
if len(argv) > 1:
    ...
    if simType == 'trackingOnly':
        ...
        sourceFile = argv[3] # e.g. './AdaptiveWiggleAttenuator/SimDataSource/AttenuatedTraj/'
        eidParam.fileName = argv[4]
        eidParam.saveDir = argv[5]
