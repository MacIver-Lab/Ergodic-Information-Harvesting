...
% Load Infotaxis data
IT_lSNR = load(['./Data/ElectricFish/', ...
    'Infotaxis-WeakSignal-Sine.mat'], ...
    'oTrajList', 'sTrajList', 'dt');
IT_hSNR = load(['./Data/ElectricFish/', ...
    'Infotaxis-StrongSignal-Sine.mat'], ...
    'oTrajList', 'sTrajList', 'dt');
...
% Ergodic Harvesting
EH_hSNR = load('./Data/Mole/ErgodicHarvesting-StrongSignal.mat', ...
    'sTrajList', 'sTrajList', 'dt');
EH_lSNR = load('./Data/Mole/ErgodicHarvesting-WeakSignal.mat', ...
    'sTrajList', 'sTrajList', 'dt');

IT_hSNR = load('./Data/Mole/Infotaxis-StrongSignal.mat', ...
    'sTrajList', 'sTrajList', 'dt');
IT_lSNR = load('./Data/Mole/Infotaxis-WeakSignal.mat', ...
    'sTrajList', 'sTrajList', 'dt');
