function makeFig7Plot(dataPath, savePath)
close all;
...
axes; hold on;
% Reference
legHdl(1) = line([refTrial.reEffortMean, refTrial.reEffortMean],...
...
line([refTrial.reEffortMean-refTrial.reEffortStd,refTrial.reEffortMean+refTrial.reEffortStd],...
    [refTrial.meanEstErrMean, refTrial.meanEstErrMean],...
    'LineWidth', 2, 'Color', colorMap(1,:));

legHdl(2) = line([lowAttenTrials.reEffortMean, lowAttenTrials.reEffortMean],...
...
line([lowAttenTrials.reEffortMean-lowAttenTrials.reEffortStd,lowAttenTrials.reEffortMean+lowAttenTrials.reEffortStd],...
    [lowAttenTrials.meanEstErrMean, lowAttenTrials.meanEstErrMean],...
    'LineWidth', 2, 'Color', colorMap(2,:));

legHdl(3) = line([medAttenTrials.reEffortMean, medAttenTrials.reEffortMean],...
...
line([medAttenTrials.reEffortMean-medAttenTrials.reEffortStd,medAttenTrials.reEffortMean+medAttenTrials.reEffortStd],...
    [medAttenTrials.meanEstErrMean, medAttenTrials.meanEstErrMean],...
    'LineWidth', 2, 'Color', colorMap(3,:));

legHdl(4) = line([highAttenTrials.reEffortMean, highAttenTrials.reEffortMean],...
...
line([highAttenTrials.reEffortMean-highAttenTrials.reEffortStd,highAttenTrials.reEffortMean+highAttenTrials.reEffortStd],...
...
plot(lowAttenTrials.reEffortRaw, lowAttenTrials.meanEstErrRaw, 'o', 'color', colorMap(2,:),...
...
% Reference line
line('XData', [1, mean(refTrial.reEffortRaw)],...
