...
- Video explainer of key concepts underlying ergodic information harvesting, and an example application of the EIH algorithm to controlling an underwater electrolocation robot: [Link to YouTube](https://youtu.be/eF6J-YmPdIA)
